...
// import managerAbi from '@/modules/blockchain/abi/Manager.json';
// import tokenAbi from '@/modules/blockchain/abi/ERC20Mock.json';
// import projectAbi from '@/modules/blockchain/abi/Project.json';
